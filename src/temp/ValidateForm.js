// https://viblo.asia/p/huong-dan-su-dung-package-react-validation-trong-reactjs-naQZR1J0Kvx
// Nguyễn Văn Quy 
                    ...
                    <div className="form-box">
                        <Form onSubmit={e => this.onSubmit(e)} ref={c => { this.form = c }}> 
                            ...
                            <Input 
                                ...
                                validations={[required, email]} // validate
                            />
                            {/* password */}
                            <Input 
                                name="password" 
                                ...
                                className="form-control" 
                                validations={[required, minLength]} // validate
                            />
