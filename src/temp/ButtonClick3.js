...
class ButtonInReactPage3 extends React.Component {
    ...
    return(
        <div>
            ...
            <button onClick={ () => {
                     var x = document.getElementById("mcaudio"); x.play();
                }
            }>Play music</button>
            <button onClick={ () => {
                    var x = document.getElementById("mcaudio"); x.pause();
                }
            }>Pause music</button>
            <input type="range" min="0.0" max="1.0" step="0.01"
...
<script>alert("hello");</script>
            ...
            <button onClick={ () => {
                     var y = document.getElementById("mcaudio2"); y.play();
                }
            }>Play music</button>
            <button onClick={ () => {
                    var y = document.getElementById("mcaudio2"); y.pause();
                }
            }>Pause music</button>
            ...
            <button onClick={ () => {
                     var z = document.getElementById("mcaudio3"); z.play();
                }
            }>Play music</button>
            <button onClick={ () => {
                    var z = document.getElementById("mcaudio3"); z.pause();
                }
            }>Pause music</button>
        </div>
    )
